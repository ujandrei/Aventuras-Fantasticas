...
def combate(pericia, forca, sorte, pericia_foe, forca_foe, sorte_foe):
    while forca > 0 and forca_foe > 0:
        ...
        print(f"O jogador tem {forca} força.")
        print(f"O inimigo tem {forca_foe} força.")
        ...
        if forca_foe <= 0:
            ...
            if cont == 's':
                ...
                if dados <= sorte:
                    ...
                    print("Tentaste fugir sem sucesso.")
...
combate(pericia, forca, sorte, pericia_foe, forca_foe, sorte_foe)          
...
#Este segmento do código iguala a variavel global, com a força do jogador no final do combate, criada no interior do motor de combate na variavel força que é
